...
async function updateCSS() {
    ...
    momotalk_theme.updateCSS((event, message) => {
...
async function updateSetting() {
    ...
    momotalk_theme.updateSetting((event, message) => {
...
async function setSetting(k, v) {
    ...
    try {
        momotalk_theme.setSetting(data)
    } catch (err) {
...
async function onConfigView(view) {
    ...
    if (typeof LiteLoader !== "undefined") {
        pluginPath = LiteLoader.plugins.momotalk_theme.path.plugin;
    } else {
        pluginPath = betterQQNT.plugins.momotalk_theme.path.plugin;
    }
